...
@section('title')
    {{trans('message.EditMainStudentDetail')}}
@endsection
...
@section('menuLink')
    <ol class="breadcrumb">
        <li>
            <a href="/manage-student" style="color:#4e5e6a; text-decoration: none;">
                {{trans('message.MainStudent')}}
            </a>
        </li>
    ...
    <ol class="breadcrumb">
        <li>
            <a href="/manage-student" style="color:#4e5e6a; text-decoration: none;">
                {{trans('message.ViewMainStudent')}}
            </a>
        </li>
        <li class="active"></li>
    </ol>
    <ol class="breadcrumb">
        <li> {{trans('message.EditMainStudentDetail')}}</li>
    </ol>
@endsection
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel info-box panel-white">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title">{{trans('message.Edit/UpdateMainStudent')}}</h4>
                </div>
                <div class="panel-body">
                    @if(empty($studentDetails))
                        <div style="text-align: center">
                            <h2>This student does not exist.</h2><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="name"
                                               value="{{null != old('name')  ? old('name') : $studentDetails['name']}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="email"
                                               value="{{null != old('email')  ? old('email') : $studentDetails['email']}}">
                                        ...
                                        <select class="js-example-responsive form-control" name="school">
                                            ...
                                            @if(!empty($schoolList))
                                                @foreach($schoolList as $key => $value)
                                                    <option @if($studentDetails['schools_id']== $value->schools_id) selected
...
@section('bodyScript')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#student, #viewStudent').addClass('active');
