...
@section('menuLink')
    <ol class="breadcrumb">
        <li>{{trans('message.ReportThree')}}</li>
...
@section('content')
    ...
    <div class="columns download">
        <p>
            <a href="{{ route('reportthreepdfview',['download'=>'pdf']) }}">{{trans('message.DownloadPDF')}}</a>
        </p>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <table id="reportThreeList" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                        <tr>
...
@section('bodyScript')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#allReport, #reportThreedetails').addClass('active');
            $('#reportThreedetails').addClass('open');
