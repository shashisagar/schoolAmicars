...
@section('title')
    {{trans('message.EditScientificRule')}}
@endsection
...
@section('menuLink')
    <ol class="breadcrumb">
        <li>{{trans('message.EditScientificRule')}}</li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel info-box panel-white">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title">{{trans('message.EditRule')}}</h4>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="post">
                        ...
                        <div class="form-body">
                            ...
                            @foreach($scientificRule as $key => $value)
