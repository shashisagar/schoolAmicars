...
@section('title')
    {{trans('message.AddScientificTerm')}}
@endsection
...
@section('menuLink')
    <ol class="breadcrumb">
        <li><a href="/manage-scientific-term" style="color:rgb(34,186,160); text-decoration: none;">{{trans('message.ViewScientificTerm')}}</a></li>
        <span class="userDefineArrow"></span>
    </ol>
    <ol class="breadcrumb">
        <li>{{trans('message.AddScientificTerm')}}</li>
    </ol>
@endsection
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel info-box panel-white">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title"> {{trans('message.AddScientificTerm')}}</h4>
                </div>
                        ...
                        <div class="form-body">
                            ...
                            <div class="clearfix"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="js-example-responsive form-control" name="scientific_rule" id="scientific_rule">
                                            <option value="">--{{trans('message.Select')}}--</option>
                                            @if(!empty($ruleList))
...
@section('bodyScript')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#courseScientificTerm, #addcourseScientificTerm').addClass('active');
            $('#courseScientificTerm').addClass('open');
