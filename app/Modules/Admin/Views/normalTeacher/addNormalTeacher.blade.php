...
@section('title')
    {{trans('message.AddNormalTeacher')}}
@endsection
...
@section('menuLink')
    <ol class="breadcrumb">
        <li><a href="/manage-normalTeacher" style="color:rgb(34,186,160); text-decoration: none;">{{trans('message.ViewNormalTeacher')}}</a></li>
        <span class="userDefineArrow"></span>
    </ol>
    <ol class="breadcrumb">
        <li>{{trans('message.AddNewNormalTeacher')}}</li>
    </ol>
@endsection
@section('head')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel info-box panel-white">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title">{{trans('message.AddNormalTeacher')}}</h4>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="post">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{{trans('message.NormalTeacherName')}}</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="normal_teacher_name" value="{{old('normal_teacher_name')}}">
                                    <span class="error">{!! $errors->first('normal_teacher_name') !!}</span>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                        ...
                        <div class="form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                <button class="btn blue btn-info" type="submit">{{trans('message.AddTeacher')}}</button>
                            </div>
                        </div>
                    </form>
...
@section('bodyScript')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#normalteacher, #addNormalTeacher').addClass('active');
            $('#normalteacher').addClass('open');
