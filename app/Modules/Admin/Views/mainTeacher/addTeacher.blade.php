...
@section('menuLink')
    <ol class="breadcrumb">
        <li><a href="/manage-teacher" style="color:rgb(34,186,160); text-decoration: none;">{{trans('message.ViewMainTeacher')}}</a></li>
        <span class="userDefineArrow"></span>
    </ol>
    <ol class="breadcrumb">
        <li>{{trans('message.AddMainTeacher')}}</li>
    </ol>
@endsection
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel info-box panel-white">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title">{{trans('message.AddMainTeacher')}}</h4>
                </div>
...
@section('bodyScript')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#teacher, #addTeacher').addClass('active');
